...
TOKEN_BUDGET = 8192        # length-bucketed training batches: pack items until items*max_len_in_bucket
                           # hits this (~median tune length(258) * 32, our batch_size sweet spot) --
                           # cuts padding waste from ~59% (random batch_size=32) to ~10% measured
